 ...
 *   Este arquivo DEVE se chamar OneSignalSDKWorker.js e
 *   DEVE estar na RAIZ do site (ex: https://seu-site.com/OneSignalSDKWorker.js).
 *   O SDK do OneSignal v16 procura nesse path exato — não dá pra
 *   renomear sem quebrar.
 *
 * Ele faz três coisas em um só SW:
 *   1. Importa o SW do OneSignal (deve ser a PRIMEIRA linha).
 *      → registra handlers de push/notificationclick.
 *   2. Cache-first para a "app shell" (HTML, manifest, ícones).
 *   3. Bypass total para origens externas (script.google.com etc.).
 * ================================================ */

importScripts('https://cdn.onesignal.com/sdks/web/v16/OneSignalSDK.sw.js');

const VERSION = 'v1.2.0'; // bump ao mexer em qualquer arquivo da shell
